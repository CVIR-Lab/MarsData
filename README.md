...
Limited by the file size, we temporarily release 100 samples in the train, validation and test set of MarsData-V2 on github, respectively. We have already released **MarsDataV2** for public, you can find and download the whole data by the following ways:
